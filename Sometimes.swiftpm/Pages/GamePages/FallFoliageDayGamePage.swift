...
struct FallFoliageDayGamePage: View {
    ...
    var body: some View {
            ...
            ZStack {
                ...
                if hasWindow {
                    ZStack {
                        ...
                        if isShowingHint {
                            VStack {
                                Text("Chapter 3. Fall Foliage Day")
                                    .font(.largeTitle)
                                Spacer()
                                ...
                                Text("(1) Drag : You can move the window by dragging.")
                                    .font(.title2)
                                    .padding()
                                Text("(2) Tap : Tap inside the window to drop nuts")
                                    .font(.title2)
                                    .padding()
                            }
        ...
        .onAppear {
            if let song = NSDataAsset(name: "AutumnMusic") {
                do {
...
struct FallFoliageDayGamePage_Previews: PreviewProvider {
